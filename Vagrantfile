...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "client-a1" do |client_a1|
    ...
    # Install dependencies and define the NAT
    client_a1.vm.provision :shell, run: "always", path: "scripts/client.sh", :args => ["172.48.48.51","0730635f1fe94e2b9ef790c1afbb7a2a", "10.0.0.1/24"]
  end
  ...
  config.vm.define "client-a2" do |client_a2|
    ...
    client_a2.vm.provision :file, source: './apps/privates/privkey2.key',
      destination: "overlay_manager/private.key"
    # Install dependencies and define the NAT
    client_a2.vm.provision :shell, run: "always", path: "scripts/client.sh", :args => ["172.48.48.51", "b3a9750ef6f5411f9352cb24280fd4aa", "10.0.0.2/24"]
  end
  ...
  config.vm.define "client-b1" do |client_b1|
    ...
    client_b1.vm.provision :file, source: './apps/privates/privkey4.key',
      destination: "overlay_manager/private.key"
    # Install dependencies and define the NAT
    client_b1.vm.provision :shell, run: "always", path: "scripts/client.sh", :args => ["172.48.48.52", "8c9501ffc280439bb1db05ad200273e3", "10.0.1.1/24"]
  end
  ...
  config.vm.define "client-b2" do |client_b2|
    ...
    client_b2.vm.provision :file, source: './apps/privates/privkey5.key',
      destination: "overlay_manager/private.key"
    # Install dependencies and define the NAT
    client_b2.vm.provision :shell, run: "always", path: "scripts/client.sh", :args => ["172.48.48.52", "4167a8e44aa24d7f84cb43f33de7aabb", "10.0.1.2/24"]
  end
  ...
  config.vm.define "server-s1" do |server_s1|
    ...
    server_s1.vm.provision :file, source: './apps/privates/privkey3.key',
      destination: "overlay_manager/private.key"
    # Install dependencies and define the NAT
    server_s1.vm.provision :shell, run: "always", path: "scripts/cloud_server.sh", :args => ["172.48.48.51", "15077bedd7ef4ab4b97d7994e42853c9", "10.0.0.3/24"]
  end
  ...
  config.vm.define "server-s2" do |server_s2|
    ...
    server_s2.vm.provision :file, source: './apps/privates/privkey6.key',
      destination: "overlay_manager/private.key"
    # Install dependencies and define the NAT
    server_s2.vm.provision :shell, run: "always", path: "scripts/cloud_server.sh", :args => ["172.48.48.52", "7473e5de88604ffc919111e01c100b77", "10.0.1.3/24"]
  end
